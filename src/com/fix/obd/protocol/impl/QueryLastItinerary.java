...
public class QueryLastItinerary extends ODBProtocolParser implements ODBProtocol{
	private static final  Logger logger = Logger.getLogger(QueryLastItinerary.class);
	 ...
	 * 这个命令没有参数
	 */
	public QueryLastItinerary(String clientId, String bufferId){
