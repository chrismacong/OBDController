...
public class ClearDTC extends ODBProtocolParser implements ODBProtocol{
	private static final  Logger logger = Logger.getLogger(ClearDTC.class);
	private String clientId;
	private String bufferId;

	public ClearDTC(String clientId, String bufferId){
		this.clientId = clientId;
		this.bufferId = bufferId;
		MessageUtil.printAndToDivContent("œÚ÷’∂À" + clientId + "∑¢ÀÕ«Â≥˝π ’œ¬Î«Î«Û",true);
	}
