...
public class RequestOBDInfo  extends ODBProtocolParser implements ODBProtocol {
	private static final  Logger logger = Logger.getLogger(RequestOBDInfo.class);
	private String protocolClientId;
	private String protocolBufferId;
	
	public RequestOBDInfo(String clientId, String bufferId){
		this.protocolClientId = clientId;
		this.protocolBufferId = bufferId;
		MessageUtil.printAndToDivContent("向终端" + clientId + "发送OBD请求",true);
	}
	@Override
