...
public class SetParameters extends ODBProtocolParser implements ODBProtocol {
	private static final  Logger logger = Logger.getLogger(SetParameters.class);
	private String protocolClientId;
	private String protocolBufferId;
	private String characterSentence;
	public SetParameters(String clientId, String bufferId, String characterSentence){
		this.protocolClientId = clientId;
		this.protocolBufferId = bufferId;
		this.characterSentence = characterSentence;
		MessageUtil.printAndToDivContent("向终端" + clientId + "发送参数设置请求",true);
	}
	@Override
