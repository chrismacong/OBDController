...
public class InstallPositionLearning extends ODBProtocolParser implements ODBProtocol{
	private static final  Logger logger = Logger.getLogger(InstallPositionLearning.class);
	private String clientId;
	private String bufferId;
	public InstallPositionLearning(String clientId, String bufferId){
		this.clientId = clientId;
		this.bufferId = bufferId;
		MessageUtil.printAndToDivContent("向终端" + clientId + "发送安装位置学习请求",true);
	}
