...
public class SendAGPSDatatime extends ODBProtocolParser implements ODBProtocol {
	private static final  Logger logger = Logger.getLogger(SendAGPSDatatime.class);
	private String protocolClientId;
	private String protocolBufferId;
	private String[] characterSentence;
	
	public SendAGPSDatatime(String clientId, String bufferId, String[] characterSentence){
		this.protocolClientId = clientId;
		this.protocolBufferId = bufferId;
		this.characterSentence = characterSentence;
		MessageUtil.printAndToDivContent("向终端" + clientId + "发送更新AGPS时间请求",true);
	}
	@Override
